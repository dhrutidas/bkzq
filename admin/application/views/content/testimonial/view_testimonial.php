...
<div class="col-md-12">
    ...
    <div class="panel-heading text-left">
        <strong>Manage Testimonial</strong>
        <div class="pull-right">
            <a href="<?php echo base_url("open-add-testimonial-modal"); ?>" data-toggle="modal" data-target="#viewModal">
    ...
    <tr>
        ...
        <th class="bg-primary col-sm-3">Message</th>
    ...
    if( !empty($chaptersArr) ):  $cnt = 1;
        ...
        foreach ($chaptersArr as $values) { ?>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo base_url("open-edit-testimonial-modal/" . $values['id'] ); ?>" data-toggle="modal" data-target="#viewModal">
