        ...
        <div class="panel panel-default">
            ...
            <div class="panel-collapse">
                    ...
                    <div class="col-sm-4">
                        <select name="inputStandard" id="inputStandard" class="form-control" disabled>
                            ...
                            <?php foreach ($allStd as $value) { ?>
                                <option value="<?php echo $value['stdID']; ?>" <?php if ($Data['session_data']['std_id'] == $value['stdID']) {
                                                                                    echo "SELECTED";
                                                                                } ?>><?php echo $value['stdName']; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select name="inputChapter" id="inputChapter" class="form-control" disabled>
                            <option value="">----Select----</option>
                        </select>
                        <div class="spin" id="chapter-spinner" style="display: none;"></div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="spin" id="level-spinner" style="display: none;"></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="spin" id="stage-spinner" style="display: none;"></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select name="inputBoard" id="inputBoard" class="form-control" disabled="disabled">
                            ...
                            <?php foreach ($allBoard as $value) { ?>
                                <option value="<?php echo $value['boardID']; ?>" <?php if ($Data['session_data']['board_id'] == $value['boardID']) {
                                                                                        echo "SELECTED";
                                                                                    } ?>><?php echo $value['boardName']; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
