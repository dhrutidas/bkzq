...
<div class="col-md-12">
    ...
    <div class="panel-heading text-left">
        <strong>Manage Stages</strong>
        <div class="pull-right">
            <a href="<?php echo base_url("open-add-stage-modal"); ?>" data-toggle="modal" data-target="#viewModal">
                <span class="glyphicon glyphicon-plus-sign"></span> Add New Stage
            </a>
        </div>
    </div>
    ...
    if( !empty($stagesArr) ):  $cnt = 1;

        foreach ($stagesArr as $values) { ?>
