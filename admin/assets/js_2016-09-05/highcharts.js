(function() {
    ...
    function Cb() {
        ...
        gb = function(a, c, d, h, i, j) {
            ...
            b ? (k = Aa.UTC.apply(0, arguments), k +=
                    Wa(k)) : k = (new Aa(a, c, p(d, 1), p(h, 0), p(i, 0), p(j, 0)))
                .getTime();
            return k
        };
        rb = c + "Minutes";
    ...
    var u, A = document,
        ...
        ba = !!A.createElementNS && !!A.createElementNS(Ca, "svg")
        .createSVGRect,
        Nb = La && parseInt(Ba.split("Firefox/")[1], 10) < 4,
        ea = !ba && !ya && !!A.createElement("canvas")
        .getContext,
        $a, ab, Kb = {},
        yb = 0,
    ...
    w.numberFormat = function(a, b,
        ...
        return e + (g ? c.substr(0, g) + d : "") + c.substr(g)
            .replace(/(\d{3})(?=\d)/g, "$1" + d) + (f ? b + O(a - c)
                .toFixed(f)
                .slice(2) : "")
    };
    zb = {
    ...
    K.prototype = {
        ...
        colorGradient: function(a, b, c) {
            ...
            if (f) {
                ...
                q = q.join(",");
                h[q] ? a = h[q].attr("id") : (g.id = a = "highcharts-" + yb++, h[q] = i = d.createElement(f)
                    .attr(g)
                    .add(d.defs), i.stops = [], m(j, function(a) {
    ...
    ta.prototype = {
        ...
        init: function(a, b, c, d, e) {
            ...
            this.boxWrapper = d;
            this.alignedObjects = [];
            this.url = (La || xb) && A.getElementsByTagName("base")
                .length ? f.href.replace(/#.*?$/, "")
                .replace(/([\('\)])/g, "\\$1")
                .replace(/ /g, "%20") : "";
            this.createElement("desc")
                .add()
                .element.appendChild(A.createTextNode("OSMOS Multimedia Pvt. Ltd."));
        ...
        buildText: function(a) {
            for (var b = a.element, c = this, d = c.forExport, e = p(a.textStr, "")
                    .toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, j = L(b, "x"), k = a.styles, l = a.textWidth, n = k && k.lineHeight, o = k && k.textShadow, q = k && k.textOverflow === "ellipsis", y = g.length, S = l && !a.added && this.box, C = function(a) {
            ...
            !f && !o && !q && e.indexOf(" ") === -1 ? b.appendChild(A.createTextNode(v(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, S && S.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">')
                .replace(/<(i|em)>/g, '<span style="font-style:italic">')
                .replace(/<a/g, "<span")
                .replace(/<\/(b|strong|i|em|a)>/g, "</span>")
                .split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), m(e, function(e, f) {
                    var g, n = 0,
                    ...
                    m(g, function(e) {
                        if (e !== "" || g.length === 1) {
                            ...
                            if (e !== " ") {
                                ...
                                if (l) {
                                    for (var o = e.replace(/([^\^])-/g, "$1- ")
                                            .split(" "), m = g.length > 1 || f || o.length > 1 && k.whiteSpace !== "nowrap", S, s, ua, u = [], t = C(y), x = 1, r = a.rotation, z = e, w = z.length;
                                        ...
                                        dy: t,
                                        x: j
                                    }), p && L(y, "style", p), b.appendChild(y)), ua > l && (l = ua)) : (y.removeChild(y.firstChild), u.unshift(o.pop())), o.length && y.appendChild(A.createTextNode(o.join(" ")
                                        .replace(/- /g, "-")));
        ...
        button: function(a, b, c, d, e, f, g, h, i) {
            ...
            N(j.element, ya ? "mouseout" : "mouseleave", function() {
                k !== 3 && (l = [e, f, g][k], n = [o, q, y][k], j.attr(l)
                    .css(n))
            });
        ...
        symbol: function(a, b, c, d, e, f) {
            ...
            if (h) g = this.path(h), r(g, {
                ...
                }, j = a.match(i)[1], a = Kb[j] || f && f.width && f.height && [f.width, f.height], g = this.image(j)
                .attr({
                    x: b,
                    y: c
...
a + c, b, a + c, b + d, a, b + d, "Z"]
        ...
        label: function(a,
            ...
            function j() {
                ...
                I = v + n.fontMetrics(a && a.fontSize, q)
                    .b;
                if (D) {
                    if (!y) a = x(-C * v), b = h ? -I : 0, o.box = y = d ? n.symbol(d, a, b, o.width, o.height, E) : n.rect(a, b, o.width, o.height, 0, E[Pb]), y.attr("fill", R)
                        .add(o);
                    y.isImg || y.attr(r({
                        width: x(o.width),
                        height: x(o.height)
        ...
        htmlUpdateTransform: function() {
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    if (o !== this.cTT) {
                        l = a.fontMetrics(b.style.fontSize)
                            .b;
                        s(k) &&
...
n, '" coordsize="10 10" style="', f.style.cssText, '" />'];
    ...
    Ta.prototype = {
        addLabel: function() {
            ...
            s(d) ? d && d.attr({
                text: b
            }) : (this.labelLength = (this.label = d = s(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML)
                    .css(z(g.style))
                    .add(a.labelGroup) :
                    null) && d.getBBox()
                .width, this.rotation = 0)
        },
        ...
        getLabelPosition: function(a, b, c, d, e, f, g, h) {
            var i = this.axis,
                ...
                c = p(e.y, n.y + (i.side === 2 ? 8 : -(c.getBBox()
                    .height / 2))),
    ...
    w.PlotLineOrBand.prototype = {
        render: function() {
            ...
            if (n)
                ...
                } else if (o && o.length && (a.svgElem = n = t.path(o)
                    .attr(v)
                    .add(), m))
            ...
            if (e && s(e.text) && o && o.length && b.width > 0 && b.height >
                ...
                if (!f) {
                    ...
                    if (s(p)) v.zIndex = p;
                    a.label = f = t.text(e.text, 0, 0, e.useHTML)
                        .attr(v)
                        .css(e.style)
                        .add()
                }
...
this.max])))) this.tickPositions = b = d;
                ...
                for (h = c.length; !f &&
                    ...
                    if (i = c[h], i = d[i].label)
                        if (i.styles.textOverflow === "ellipsis" && i.css({
                            ...
                            .height > this.len / c.length - (g.h - g.f)) i.specCss = {
                            textOverflow: "ellipsis"
                        }
            }
            j.rotation && (k = {
        ...
        getOffset: function() {
            ...
            if (q && q.text && q.enabled !== !1) {
                if (!a.axisTitle) a.axisTitle = c.text(q.text, 0, 0, q.useHTML)
                    .attr({
                        zIndex: 7,
        ...
        render: function() {
            ...
            if (y || f) {
                ...
                if (!a._addedPlotLB) m((d.plotLines || [])
                    .concat(d.plotBands || []),
                    function(b) {
    ...
    r(va.prototype, {
        ...
        addPlotBandOrLine: function(a, b) {
            var c = (new w.PlotLineOrBand(this, a))
                .render(),
                d = this.userOptions;
...
[1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week", [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]],
    ...
    Mb.prototype = {
        ...
        refresh: function(a, b) {
            ...
            i === !1 ? this.hide() : (this.isHidden && (db(d), d.attr("opacity", 1)
                .show()), d.attr({
                text: i
    ...
    Va.prototype = {
        ...
        drag: function(a) {
            ...
            if (this.hasDragged > 10) {
                ...
                if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !q && !this.selectionMarker) this.selectionMarker = b.renderer.rect(h, i, f ? 1 : j, g ? 1 : k, 0)
                    .attr({
    ...
    mb.prototype = {
        ...
        renderTitle: function() {
            ...
            if (b.text) {
                if (!this.title) this.title = this.chart.renderer.label(b.text,
                        a - 3, a - 4, null, null, null, null, null, "legend-title")
                    .attr({
                        zIndex: 1
                    })
                    .css(b.style)
        ...
        renderItem: function(a) {
            ...
            if (!m) {
                ...
                a.legendItem = m = c.text(d.labelFormat ? Ja(d.labelFormat, a) : d.labelFormatter.call(a), l ? f + g : -g, this.baseline || 0, r)
                    .css(z(a.visible ? h : i))
                    .attr({
                        align: l ? "left" : "right",
                        zIndex: 2
    ...
    Na = w.LegendSymbolMixin = {
        drawRectangle: function(a, b) {
            ...
            b.legendSymbol = this.chart.renderer.rect(0, a.baseline - c + 1, a.symbolWidth, c, a.options.symbolRadius || 0)
                .attr({
                    zIndex: 3
                })
                .add(b.legendGroup)
    ...
    D.prototype = {
        ...
        layOutTitles: function(a) {
            ...
            d && (d.css({
                ...
                .align(r({
                    y: b +
                        (f.margin - 13) + g.fontMetrics(f.style.fontSize, d)
                        .b
                }, e), !1, "spacingBox"), !e.floating && !e.verticalAlign && (b = sa(b + d.getBBox()
                    .height)));
        ...
        drawChartBox: function() {
            ...
            if (i || j)
                if (e) e.animate(e.crisp({
                    ...
                    if (i) e.stroke = a.borderColor, e["stroke-width"] =
                        i;
                    this.chartBackground = b.rect(o / 2, o / 2, c - o, d - o, a.borderRadius, i)
                        .attr(e)
                        .addClass("highcharts-background")
                        .add()
                        .shadow(a.shadow)
                }
            if (k) f ? f.animate(v) : this.plotBackground = b.rect(q, p, m, s, 0)
                .attr({
                    fill: k
                })
                .add()
                .shadow(a.plotShadow);
            if (l) h ? h.animate(v) : this.plotBGImage = b.image(l, q, p, m, s)
                .add();
            r ? r.animate({
                width: t.width,
                height: t.height
            ...
            if (n) g ? g.animate(g.crisp({
                    ...
                    height: s,
                    strokeWidth: -n
                })) : this.plotBorder = b.rect(q, p, m, s, 0, -n)
                .attr({
    ...
    Q.prototype = {
            ...
            if (l.enabled !== !1 || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = U(g.plotX), e = g.plotY, k = g.graphic, o = g.marker || {}, q = !!g.marker, a = t && o.enabled === u ||
                        ...
                        if (a = g.pointAttr[g.selected ? "select" : ""] || n, h = a.r, i = p(o.symbol, this.symbol), j = i.indexOf("url") === 0, k) k[m ? "show" : "hide"](!0)
                            .animate(r({
                                x: d - h,
                                y: e - h
                            }, k.symbolName ? {
                            ...
                            if (m && (h > 0 || j)) g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h, q ? o : l)
                                .attr(a)
                                .add(s)
        ...
        getAttribs: function() {
            ...
            var p = a.zones,
                t = a.zoneAxis || "y",
                C;
            b.marker ? (e.radius = e.radius || c.radius + e.radiusPlus, e.lineWidth = e.lineWidth || c.lineWidth + e.lineWidthPlus) : (e.color = e.color || na(e.color || g)
                .brighten(e.brightness)
                .get(),
                e.negativeColor = e.negativeColor || na(e.negativeColor || h)
                .brighten(e.brightness)
                .get());
            ...
            if (!j || g < j || l)
                for (; g--;) {
                    ...
                    if (l) {
                        ...
                        f = d.hover =
                            d.hover || {};
                        if (!b.marker) f.color = f.color || !j.options.color && e[j.negative && h ? "negativeColor" : "color"] || na(j.color)
...
b.lineColor || this.color, b.dashStyle]],
            ...
            m(c, function(c, i) {
                ...
                if (k) db(k), k.animate({
                    d: f
                        ...
                        fill: g,
                        zIndex: 1
                    }, c[2] ? k.dashstyle = c[2] : e && (k["stroke-linecap"] = k["stroke-linejoin"] = "round"), a[j] = a.chart.renderer.path(f)
                    .attr(k)
                    .add(a.group)
                    .shadow(i < 2 &&
                        b.shadow)
        ...
        plotGroup: function(a, b, c, d, e) {
            var f = this[a],
                g = !f;
            g && (this[a] = f = this.chart.renderer.g(b)
                .attr({
                    visibility: c,
                    zIndex: d || 0.1
                })
...
h + e.pos - b.plotTop];
        ...
        drawPoints: function() {
            ...
            m(a.points, function(h) {
                ...
                if (i !== u && !isNaN(i) && h.y !== null) f = h.shapeArgs, i = s(a.borderWidth) ? {
                        ...
                        ""] || a.pointAttr[""], j ? (db(j), j.attr(i)[b.pointCount < e ? "animate" : "attr"](z(f))) : h.graphic = d[h.shapeType](f)
                    .attr(i)
                    .attr(g)
                    .add(a.group)
            ...
            if (d.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(d), j = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), p(d.defer, !0) && (j.attr({
                ...
                if (m && !h) e.dataLabel = m.destroy();
                    ...
                    if (m)
                        ...
                        m = e.dataLabel = k[h ? "text" : "label"](i, 0, -999, d.shape, null, null, d.useHTML)
                            .attr(m)
                            .css(r(v, A))
                            .add(j)
                            .shadow(d.shadow)
    ...
    Q.prototype.alignDataLabel = function(a, b, c, d, e) {
        var f = this.chart,
            ...
            i = p(a.plotY, -999),
            j = b.getBBox(),
            k = f.renderer.fontMetrics(c.style.fontSize)
            .b,
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            for (G = 2; G--;) {
                ...
                if (L) {
                    ...
                    for (E = b = 0; !b && H[E];) b = H[E] && H[E].dataLabel && (H[E].dataLabel.getBBox()
                        .height || 21), E++;
                    if (n > 0) {
            ...
            if (Fa(F) === 0 || this.verifyDataLabelOverflow(F)) this.placeDataLabels(), s && g && m(this.points, function(b) {
                ...
                if ((u = b.dataLabel) && u._pos) D = u._attr.visibility, A = u.connX, B = u.connY, k = l ? ["M", A + (w[6] === "left" ? 5 : -5), B, "C", A, B, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], "L", w[4], w[5]] : ["M", A + (w[6] === "left" ? 5 : -5), B, "L", w[2], w[3], "L", w[4], w[5]], j ? (j.animate({
                    ...
                    b.connector = j = a.chart.renderer.path(k)
                    .attr({
                        "stroke-width": g,
            ...
            for (d = 0; d < b; d++) {
                ...
                for (c = d + 1; c < b; ++c)
                    if (j = a[c], i && j && i.placed && j.placed && i.newOpacity !== 0 && j.newOpacity !==
                        0 && !(j.alignAttr.x > i.alignAttr.x + i.width || j.alignAttr.x + j.width < i.alignAttr.x || j.alignAttr.y > i.alignAttr.y + i.height || j.alignAttr.y + j.height < i.alignAttr.y))(i.labelrank < j.labelrank ? i : j)
                        .newOpacity = 0
            }
            for (d = 0; d < b; d++)
                if (c = a[d]) {
    ...
    r(Ga.prototype, {
        ...
        importEvents: function() {
            if (!this.hasImportedEvents) {
                var a = z(this.series.options.point, this.options)
                    .events,
                    b;
                this.events = a;
                for (b in a) N(this,
